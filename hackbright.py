...
def get_project_by_title(title):
    ...
    print 'Project: {}, description: {}'.format(row[0], row[1])
...
def get_grade_by_github_title(github, title):
    ...
    print "Student with Github: {} received a {} on {}.".format(row[0], row[2], row[1])
...
def assign_grade(github, title, grade):
    ...
    print "Successfully entered {} for {} on {}.".format(student_github, grade, project_title)
